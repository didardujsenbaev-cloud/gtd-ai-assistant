"""
Seed: Алматы / ИЖС / Снос дома или хозпостройки.

Услуга:    SVC-IZH-004 (новая — создаём)
Шаблон:    RMT-IZH-ALM-DEMOLITION-001
9 этапов, 1 чек-лист, 1 SOP.

Использование:
    python3 business_core/seeds/seed_izhs_almaty_demolition.py --dry-run
    python3 business_core/seeds/seed_izhs_almaty_demolition.py
...
SERVICE_ID   = "SVC-IZH-004"
TEMPLATE_ID  = "RMT-IZH-ALM-DEMOLITION-001"
CHECKLIST_ID = "CHK-IZH-ALM-DEMOLITION-DOCS-001"
SOP_ID       = "SOP-IZH-ALM-DEMOLITION-PRIMARY-001"
BIZ_ID       = "BIZ-001"

# ─── Данные услуги ───────────────────────────────────────────

SERVICE_DATA = dict(
    service_name=            "Снос дома / хозпостройки",
    biz_id=                  BIZ_ID,
    ...
    description=             (
        "Сопровождение процедуры сноса жилого дома или хозпостройки на участке ИЖС в Алматы: "
        "техническое обследование, заключение о сносе, решение архитектуры, "
        "акт сноса и регистрация изменений."
    ),
    what_included=           (
    ...
    risks=                   (
        "объект не зарегистрирован; документы неполные; технический паспорт отсутствует; "
        "архитектура может выдать замечания; "
...
TEMPLATE_DATA = dict(
    template_name= "Алматы / ИЖС / снос дома или хозпостройки",
    biz_id=        BIZ_ID,
    service_id=    SERVICE_ID,
    case_type=     "almaty_izhs_demolition",
    object_type=   "private_house_izhs",
    description=   (
        "Шаблон для сопровождения сноса жилого дома или хозпостройки "
        "на участке ИЖС в Алматы."
    ),
    status=        "active",
    notes=         (
...
STAGES = [
    dict(
        ...
        description=   (
            "Проверяем, какой объект планируется снести: жилой дом, баня, гараж, сарай "
            "или другая хозпостройка. Определяем, зарегистрирован ли объект "
    ...
    dict(
        ...
        description=   (
            "Проверяем существующий технический паспорт или координируем его получение/"
            "актуализацию, если это нужно для процедуры сноса."
        ),
    ...
    dict(
        ...
        description=   (
            "Формируем пакет и подаем документы для получения решения архитектуры на снос."
        ),
        required_docs= (
...
CHECKLIST_DATA = dict(
    title=       "Чек-лист документов для сноса дома / хозпостройки в Алматы",
    biz_id=      BIZ_ID,
    service_id=  SERVICE_ID,
...
SOP_DATA = dict(
    title=            "Как определить услугу сноса дома / хозпостройки в Алматы",
    biz_id=           BIZ_ID,
    service_id=       SERVICE_ID,
    template_id=      TEMPLATE_ID,
    purpose=          (
    ...
    expected_result=  (
        "Выбран шаблон RMT-IZH-ALM-DEMOLITION-001 или выявлены причины, "
        "почему объект нельзя вести в работу."
    ),
    owner_role=       "manager",
    status=           "active",
)
...
def main() -> None:
    ...
    print("=" * 60)
    print("Seed: Алматы / ИЖС / Снос дома или хозпостройки (SVC-IZH-004)")
    print("Template: RMT-IZH-ALM-DEMOLITION-001 | 9 этапов")
    print("=" * 60)
